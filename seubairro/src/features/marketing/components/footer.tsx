        ...
        <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr_1fr] gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/#proposito" className="hover:text-white transition-colors">Propósito</Link></li>
              <li><Link href="/#para-quem" className="hover:text-white transition-colors">Para Moradores</Link></li>
              <li><Link href="/#para-quem" className="hover:text-white transition-colors">Para Negócios</Link></li>
              <li><Link href="/#como-funciona" className="hover:text-white transition-colors">Como Funciona</Link></li>
              <li><Link href="/#roadmap" className="hover:text-white transition-colors">Trajetória</Link></li>
