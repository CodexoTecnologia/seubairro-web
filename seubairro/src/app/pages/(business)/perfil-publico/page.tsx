...
export default function BusinessPerfilPage() {
    const businessData = {
        ...
        products: [
            { id: 1, title: "Pão Francês Fresquinho", price: "R$ 12,90/kg", image: "https:
            { id: 2, title: "Leite Integral", price: "R$ 4,50", image: "https:
            { id: 3, title: "Café Torrado", price: "R$ 18,90", image: "https:
            { id: 4, title: "Queijo Mussarela", price: "R$ 45,90/kg", image: "https:
        ]
    }
    return (
